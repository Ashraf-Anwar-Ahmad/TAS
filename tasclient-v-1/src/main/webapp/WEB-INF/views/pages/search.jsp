					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<label>Type of Threat</label> <select
									class="form-control select2" name="threatTypeName"
									id="threatTypeName">
						...
						<div class="col-md-3 hide" id="smugglingcol">
							<div class="form-group">
								<label>Smuggling Type</label> <select
									class="form-control select2" name="smugglingItem"
									id="smugglingItem">
									<option value="">Select</option>
						...
						<div class="col-md-3 hide" id="contrabandtypecol">
							<div class="form-group">
								<label>Contraband Type</label> <select
									class="form-control select2" name="smugglingItem"
									id="contraband_smugglingItem">
									<option value="">Select</option>
									<c:forEach items="${contrabandTypeList}" var="contraListItem">
										<option value="${contraListItem.id}">${contraListItem.name}</option>
									</c:forEach>
								</select>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label>Search By</label> <select class="form-control select2"
									id="search_by" name="search_by" required="required"
						...
						<div class="col-md-3 hide" id="lattitude">
							<div class="form-group">
								<label>Latitude</label> <input type="text" class="form-control"
									value="" name="lattitude_input" id="lattitude_input" />
							</div>
						</div>
						<div class="col-md-3 hide" id="longitude">
							<div class="form-group">
								<label>Longitude</label> <input type="text" class="form-control"
									value="" name="longitude_input" id="longitude_input" />
							</div>
						</div>
						<div class="col-md-3 hide" id="registration-search">
							<div class="form-group">
								<label>Reg. No.</label> <input type="text" class="form-control"
									value="" name="registration-input" id="registration-input" />
							</div>
						</div>
						<div class="col-md-3 hide" id="portreg-search">
							<div class="form-group">
								<label>Port. Reg.</label> <input type="text"
									class="form-control" value="" name="port-input" id="port-input" />
							</div>
						</div>
						<div class="col-md-3 hide" id="lpc-search">
							<div class="form-group">
								<label>LPC</label> <input type="text" class="form-control"
									value="" name="lpc-input" id="lpc-input" />
							</div>
						</div>
						<div class="col-md-3 hide" id="npc-search">
							<div class="form-group">
								<label>NPC</label> <input type="text" class="form-control"
									value="" name="npc-input" id="npc-input" />
							</div>
						</div>

						<div class="col-md-3 searchother" id="search_term_div"
							style="display: none">
							<div class="form-group" id="search_term_input_div"
								style="display: none">
								<label><span id="input_label">Search Term</span></label> <input
									type="text" class="form-control" value="" name="search_term"
									id="search_term" />
							</div>
							<div class="form-group" id="search_term_date_div"
								style="display: none">
								<label><span id="cal_label">Search Term</span></label> <input
									type="text" class="form-control dat" name="search_term_date"
									id="search_term_date" onkeydown="return false" readonly
									style="background-color: #ffff" />
							</div>

							<div class="form-group" id="search_term_select_div"
								style="display: none">
								<label><span id="select_label">Search Term</span></label> <select
									class="form-control select2" name="search_type_select" required
						...
						<div class="col-md-3 hide" id="todate-search">
							<div class="form-group">
								<label><span id="cal_label">Select To Date</span></label> <input
									type="text" class="form-control dat" name="todate-input"
									id="todate-input" onkeydown="return false" readonly
									style="background-color: #ffff" />
							</div>
						</div>
						<div class="col-md-6">
							<div style="margin-top: 1.4rem">
								<input type="button" id="btn_search" class="btn btn-info"
