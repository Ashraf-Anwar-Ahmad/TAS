															...
															<div class="row">
																<div class="col-md-6">
																	...
																	<div class="form-group">
																		<label>Latitude <small>(Deg, Min, Sec)</small></label>
																		<input type="text" class="form-control"
																			name="applattitudeDeg" id="applattitudeDeg" />
																	</div>
																...
																<div class="col-md-6 mpdw">
																	...
																	<div class="form-group">
																		<label>Longitude <small>(Deg, Min,
																				Sec)</small></label> <input type="text" class="form-control"
																			name="applongitudeDeg" id="applongitudeDeg" />
																	</div>
...
$('#addAmmunitButton').hide();
	...
	$('#typeAmmun').val(amuntArray[0]);$('#quantity').val(amuntArray[1]);
	$('#ammunMake').val(amuntArray[2]);$('#ammunModel').val(amuntArray[3]);
	$('#ammunManuCntry').val(amuntArray[4]); $('#ammunRmks').val(amuntArray[5]);
	$('#armsDetails').val(amuntArray[6]);
	$('#ammdetails').val(amuntArray[7]);
	$('#weight').val(amuntArray[8]).trigger("change");
...
function submitThreatDetails(){
 ...
 $.ajax({
		url : 'saveCounterDetails?uploadedInputId='+uploadedInputId,
...
$('#inputId').focusout(function(){
    ...
    //below for on change of threat type:-
...
//below for alert notfication
  ...
  //below for submit threat check
    function threatCheckDetails(){
    	...
    	data["boatList"]=[];
    	data["vesselList"]=[];//(0306)
    	if(filesToUpload.length >0 ){  //02062020
