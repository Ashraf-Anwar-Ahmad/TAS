							...
							<div class="col-12   ml-auto mr-auto mb-4">
								<div class="multisteps-form__progress">
									...
									<button class="multisteps-form__progress-btn" type="button"
										title="Counter Terrorism Details" disabled="disabled">Counter
										Terrorism Details</button>
									<button class="multisteps-form__progress-btn" type="button"
										title="Boat/Vessels Details" disabled="disabled">Boat/Vessels
										Details</button>
									<button class="multisteps-form__progress-btn" type="button"
										title="Crew Details" disabled="disabled">Crew Details
									</button>
									<button class="multisteps-form__progress-btn" type="button"
										title="Ammunition Details" disabled="disabled">Ammunition
										Details</button>
									<button class="multisteps-form__progress-btn" type="button"
							...
							<div class="col-12 m-auto">
								<form class="multisteps-form__form">
									...
									<div class="multisteps-form__panel shadow p-4 rounded bg-white"
										data-animation="scaleIn">
										<h3 class="multisteps-form__title">Counter Terrorism
											Details</h3>
										<div class="multisteps-form__content">

											<!--Contraband Smuggling details form start-->
									...
									<div class="multisteps-form__panel shadow p-4 rounded bg-white"
										data-animation="scaleIn">
										<h3 class="multisteps-form__title">Details of Ammunition</h3>
										<div class="multisteps-form__content">

											<!--Ammunition details input start-->
											<div class="row">
												<div class="col-md-3">
													<div class="form-group">
														<label>Type Of Ammunition</label> <input type="text"
															class="form-control ammunitcl" name="typeAmmun"
															id="typeAmmun" />
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="form-group">
														...
														<!-- 2905, add (In Number) -->
														<input type="number" class="form-control ammunitcl"
												...
												<div class="col-md-3">
													<div class="form-group">
														...
														<select class="form-control select2 ammunitcl"
												...
												<div class="col-md-3">
													<div class="form-group">
														<label>Make</label> <input type="text"
															class="form-control ammunitcl" id="ammunMake"
															name="ammunMake">
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="form-group">
														<label>Model</label> <input type="text"
															class="form-control ammunitcl" id="ammunModel"
															name="ammunModel">
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="form-group">
														<label>Manufacture Country</label> <input type="text"
															class="form-control ammunitcl" id="ammunManuCntry"
															name="ammunManuCntry">
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="form-group">
														<label>Ammunition Details</label> <input type="text"
															class="form-control ammunitcl" id="ammdetails"
															name="ammdetails">
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="form-group">
														<label>Arms Details</label> <input type="text"
															class="form-control ammunitcl" id="armsDetails"
															name="armsDetails">
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="form-group">
														<label>Remarks</label> <input type="text"
															class="form-control ammunitcl" id="ammunRmks"
															name="ammunRmks">
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="form-group mt-4">
														<button type="button" id="addAmmunitButton"
															onclick="fnClickAddAmmunit()" class="btn btn-primary">Add</button>
														<button type="button" style="display: none;"
															id="updateAmmunitButton" onclick="fnClickAddAmmunit()"
															class="btn btn-primary">Update</button>
													</div>
												</div>
												<div class="col-md-12">
													<div class="btAmmunit" style="display: none">
														<button class="btn btn-default" id="ammunitEye"
															type="button" data-toggle="modal"
															data-target="#ammunit_det">
															<i class="fa fa-eye"></i> <span id="sizeAmmunit"></span>
														</button>
													</div>
												</div>
											</div>
											<!--Ammunition details input End-->
...
<!--Ammunition modal start-->

<div class="modal fade pdr0" id="ammunit_det" data-backdrop="static"
	tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
	<div class="modal-dialog modal-xl-free" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Ammunition
					Details</h5>
				<button type="button" class="close" data-dismiss="modal"
					aria-label="Close">
					<span aria-hidden="true">&times;</span>
...
//3006
			//below for Ammunition details

			var ammunitDataList=[];
			function fnClickAddAmmunit() {
					//$('#giffy').show();
					
					var boolCheck=false;
					var filteredFamily = ammunitDataList.filter(function(x) {
			  		if (x.ammunModel==$("#ammunModel").val()) {
			   			//alert("check1");
			   			boolCheck=true;
			  		}
					});
					if(boolCheck)
			  		{
						$.confirm({
						    title: 'Alert!',
						    content: 'You have already added the same model Name',
						    theme: 'material',
						    type: 'orange',
						    buttons: {
						        Ok: function () {
					...
					var myFormInputs = document.getElementsByClassName("ammunitcl") ;
					var boolAmmunit=true;
					var myFormData = Array.prototype.filter.call(myFormInputs, function(anElement) {
						//alert("myFormInputs=="+anElement.value);
						if(anElement.value==''){
							anElement.value='';
						}
						arr_ammunit.push(anElement.value);
					})
					//alert("myFormInputs=="+JSON.stringify(arr_ammunit));
					
					if($('#ammunModel').val()!=''){
						$('#ammunitEye').attr('disabled',false);
						$('#addAmmunitButton').show();
						$('#updateAmmunitButton').hide();
						
							amtUpd=0;//(0206)
							 $('#ammunit_table').dataTable().fnAddData( [
								 arr_ammunit[0],arr_ammunit[1],arr_ammunit[2],arr_ammunit[3],arr_ammunit[4],arr_ammunit[5],
								 '<button type="button" onclick="dataTableUpdateAmmunit(\''+arr_ammunit+'\',this)" class="btn btn-blue btn-sm1"><i class="fa fa-edit"></i></button> <button type="button" onclick="dataTableDeleteAmmunit(\''+arr_ammunit[3]+'\',this)" class="btn btn-danger btn-sm1"><i class="fa fa-remove"></i></button>'] );
							 var dataAmmunit = {};
							 dataAmmunit["typeAmmun"] = arr_ammunit[0];dataAmmunit["ammunQty"] = arr_ammunit[1];dataAmmunit["ammunMake"] = arr_ammunit[2];dataAmmunit["ammunModel"] = arr_ammunit[3];
							 dataAmmunit["ammunManuCntry"] = arr_ammunit[4];dataAmmunit["ammunRmks"] = arr_ammunit[5];
							 ammunitDataList.push(dataAmmunit);
							 
							 $('#typeAmmun, #ammunQty, #ammunMake, #ammunModel, #ammunManuCntry, #ammunRmks').val('');
						
							 
							 //alert("data=="+JSON.stringify(ammunitDataList));
							 $("#sizeAmmunit").text(ammunitDataList.length+' records added');
							 $(".btAmmunit").show();
						...
						$.confirm({
						    title: 'Alert!',
						    content: 'Please add atleast model name',
						    theme: 'material',
						    type: 'orange',
						    buttons: {
						        Ok: function () {
			...
			function dataTableUpdateAmmunit(amuntArr,obj)
			{
				$('#addAmmunitButton').hide();
					$('#updateAmmunitButton').show();
					amtUpd=1;//(0206)
					$('#ammunitEye').attr('disabled',true);
					var amuntArray = amuntArr.split(",");
					//alert("ch=="+amuntArray[1]);
					ammunitDataList = $.grep(ammunitDataList, function(el, idx) {return el.ammunModel == amuntArray[3]}, true)
					//alert("data=="+JSON.stringify(ammunitDataList));
					$('#typeAmmun').val(amuntArray[0]);$('#ammunQty').val(amuntArray[1]);$('#ammunMake').val(amuntArray[2]);$('#ammunModel').val(amuntArray[3]);
					$('#ammunManuCntry').val(amuntArray[4]); $('#ammunRmks').val(amuntArray[5]);


					$('#ammunit_det').modal('toggle'); 
					$('#ammunit_table').DataTable().row($(obj).parents('tr')).remove().draw(false);
			}

			function dataTableDeleteAmmunit(value,obj)
			{
					ammunitDataList = $.grep(ammunitDataList, function(el, idx) {return el.ammunModel == value}, true)
					//alert("data=="+JSON.stringify(ammunitDataList));
					$('#ammunit_table').DataTable().row($(obj).parents('tr')).remove().draw(false);
					$("#sizeAmmunit").text(ammunitDataList.length+' records added');
					if(ammunitDataList.length==0){
						$(".btAmmunit").hide();
						$('#ammunit_det').modal('toggle'); 
					}
			} 
...
$(document).ready(function() {
	...
	ammunitDataList=test.ammunitionList;
...
for(i in ammunitDataList){
		var arr_ammunit=test.ammunitionStrList[i];
		$('#ammunit_table').dataTable().fnAddData( [
			ammunitDataList[i].typeAmmun,
			ammunitDataList[i].ammunQty,
			ammunitDataList[i].ammuUnitName,
			ammunitDataList[i].ammunMake,
			ammunitDataList[i].ammunModel,
			ammunitDataList[i].ammunManuCntry,
			ammunitDataList[i].ammdetails,
			ammunitDataList[i].armsDetails,
			ammunitDataList[i].ammunRmks,
			 '<button type="button" onclick="dataTableUpdateAmmunit(\''+arr_ammunit+'\',\''+ammunitDataList[i].ammunId+'\',this)" class="btn btn-blue btn-sm1"><i class="fa fa-edit"></i></button> <button type="button" onclick="dataTableDeleteAmmunit(\''+arr_ammunit[0]+'\',\''+ammunitDataList[i].ammunId+'\',this)" class="btn btn-danger btn-sm1"><i class="fa fa-remove"></i></button>'] );
	} 
	...
	ammunitDataList.length>0?$(".btAmmunit").show():$(".btAmmunit").hide();
	$("#sizeAmmunit").text(ammunitDataList.length+' records added');	
...
//	$('#imeiNo').val(test.imeiNo);
	...
	$('#applattitudeDec').val(test.applattitudeDec);
	$('#applongitudeDec').val(test.applongitudeDec);
	$('#applattitudeDeg').val(test.applattitudeDeg);
	$('#applongitudeDeg').val(test.applongitudeDeg);
	$('#otherInfo').val(test.otherInfo);
	$('#followUp').val(test.followUp);
	$('#otherUnit').val(test.otherUnit);
...
//	$('#sharedWithName').val(test.sharedWithId);
...
function fnClickAddAmmunit() {
		...
		ammunitId==null || ammunitId=='' ? ammunitId='' : ammunitId=ammunitId+'-U';
		...
		if($('#ammunModel').val()!=''){
			...
			amtUpd=0;//(0206)
			var ammuntUnit;
			$('#weight option:selected').text()=='Select'?ammuntUnit='':ammuntUnit=$('#weight option:selected').text();
			$('#ammunit_table').dataTable().fnAddData([
				 arr_ammunit[0],arr_ammunit[1],ammuntUnit,arr_ammunit[3],arr_ammunit[4],arr_ammunit[5],arr_ammunit[6],
				 arr_ammunit[7],arr_ammunit[8],
				 '<button type="button" onclick="dataTableUpdateAmmunit(\''+arr_ammunit+'\',this)" class="btn btn-blue btn-sm1"><i class="fa fa-edit"></i></button> <button type="button" onclick="dataTableDeleteAmmunit(\''+arr_ammunit[3]+'\',\''+ ''+'\',this)" class="btn btn-danger btn-sm1"><i class="fa fa-remove"></i></button>'] );
			  var dataAmmunit = {};
			 
			 dataAmmunit["typeAmmun"] = arr_ammunit[0];dataAmmunit["ammunQty"] = arr_ammunit[1];
			 dataAmmunit["ammunMake"] = arr_ammunit[3];dataAmmunit["ammunModel"] = arr_ammunit[4];
			 dataAmmunit["ammunManuCntry"] = arr_ammunit[5];
			 dataAmmunit["ammunRmks"] = arr_ammunit[8];
			 dataAmmunit["armsDetails"] = arr_ammunit[7];
			 dataAmmunit["ammdetails"] = arr_ammunit[6];
			 dataAmmunit["ammuUnit"] = arr_ammunit[2];
			 ammunitDataList.push(dataAmmunit);
			 
			 $('#typeAmmun,#quantity, #ammunMake, #ammunModel, #ammunManuCntry,#ammdetails,#armsDetails ,#ammunRmks').val('');
...
function dataTableUpdateAmmunit(amuntArr,text2,obj)
{
	$('#addAmmunitButton').hide();
	$('#updateAmmunitButton').show();
	amtUpd=1;//(0206)
	$('#ammunitEye').attr('disabled',true);
	var amuntArray = amuntArr.split(",");
		ammunitDataList = $.grep(ammunitDataList, function(el, idx) {return el.ammunModel == amuntArray[5]}, true);
		//below for assigning values back to form
	$('#typeAmmun').val(amuntArray[0]).trigger("change");
	$('#quantity').val(amuntArray[1]);
	$('#weight').val(amuntArray[2]).trigger("change");
	$('#ammunMake').val(amuntArray[4]);
	$('#ammunModel').val(amuntArray[5]);
	$('#ammunManuCntry').val(amuntArray[6]); 
	$('#ammdetails').val(amuntArray[7]);
	$('#armsDetails').val(amuntArray[8]);
	$('#ammunRmks').val(amuntArray[9]);
	$('#ammunit_det').modal('toggle'); 
	$('#ammunit_table').DataTable().row($(obj).parents('tr')).remove().draw(false);
}

function dataTableDeleteAmmunit(value,text2,obj)
{
	if(text2!='' && text2!=null){
		var dataAmmunDel = {};
		var delamm=text2.split('-');
		dataAmmunDel["ammunId"] = delamm[0]+'-D';
		ammunitDelList.push(dataAmmunDel);
		ammunitDelChk.push(dataAmmunDel);
	}
		ammunitDataList = $.grep(ammunitDataList, function(el, idx) {return el.ammunModel == value}, true)
		//alert("data=="+JSON.stringify(ammunitDataList));
		$('#ammunit_table').DataTable().row($(obj).parents('tr')).remove().draw(false);
		Array.prototype.push.apply(ammunitDataList,ammunitDelList);
		ammunitDelList=[];
		$("#sizeAmmunit").text((ammunitDataList.length)-(ammunitDelChk.length)+' records added');
		if((ammunitDataList.length)-(ammunitDelChk.length)==0){
			$(".btAmmunit").hide();
			$('#ammunit_det').modal('toggle'); 
		}
		//alert("data merged=="+JSON.stringify(ammunitDataList));
} 
		...
		if($('#boatName').val()!=''){//below 2905
			...
			if(botConLen.length <10 && botConLen!=''){
				...
				$('#typeOfBoat option:selected').text()=='Select'?boatType='':boatType=$('#typeOfBoat option:selected').text();
				 ...
				 $('#typeOfBoat,#boatColour,#boatColrcd').val('').trigger('change');
               			...
               			if(response.Status == 200){
               		    	...
               		    	// to remove all selected file  
    	           			 ...
    	           			 for (i = 0; i < obj.length; i++) { 
    	           			     ts+= "<li><a   href=\"viewdoc?fileName="+obj[i]+"&inputId=${inputId}&threatFolder=counterTerrorist\" target=\"_blank\"> <strong class=\"t\">"+obj[i]+"</strong>  </a>"
...
function submitThreatDetails(){
	...
	data["ammunitionList"]=ammunitDataList;
