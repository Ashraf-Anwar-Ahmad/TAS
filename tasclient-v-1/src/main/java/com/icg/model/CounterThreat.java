...
public class CounterThreat {
	...
	public String toString() {
		return "CounterThreat [threatId=" + threatId + ", threatTypeId=" + threatTypeId + ", threatTypeName="
				...
				+ ", icgUnitsName=" + icgUnitsName + ", applattitudeDec=" + applattitudeDec + ", applongitudeDec="
				...
				+ ", ammunitionList=" + ammunitionList + ", ammunitionStrList=" + ammunitionStrList + ", otherInfo="
				+ otherInfo + ", followUp=" + followUp + ", uploadDocs=" + uploadDocs + ", fromWhere=" + fromWhere
				+ ", locationName=" + locationName + ", otherUnit=" + otherUnit + "]";
	}
}
