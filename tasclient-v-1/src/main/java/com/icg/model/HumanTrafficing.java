...
public class HumanTrafficing {
	...
	public String toString() {
		return "HumanTrafficing [threatId=" + threatId + ", threatTypeId=" + threatTypeId + ", threatTypeName="
				...
				+ ", nameSuspects=" + nameSuspects + ", sharedWithId=" + sharedWithId + ", sharedWithName="
				+ sharedWithName + ", sharedWithOther=" + sharedWithOther + ", icgUnitsId=" + icgUnitsId
				+ ", icgUnitsName=" + icgUnitsName + ", caseHandedTo=" + caseHandedTo + ", jointOperWith="
				...
				+ crewList + ", crewStrList=" + crewStrList + ", otherInfo=" + otherInfo + ", followUp=" + followUp
