...
public class NarcoticThreat {
	...
	public String toString() {
		return "NarcoticThreat [threatId=" + threatId + ", threatTypeId=" + threatTypeId + ", threatTypeName="
				...
				+ sharedWithName + ", sharedWithOther=" + sharedWithOther + ", narcoDate=" + narcoDate + ", icgUnitsId="
				+ icgUnitsId + ", icgUnitsName=" + icgUnitsName + ",  worth=" + worth
				+ ", caseHandedTo=" + caseHandedTo + ", broughtTo=" + broughtTo + ", jointOperWith=" + jointOperWith
				+ ", applattitudeDec=" + applattitudeDec + ", applongitudeDec=" + applongitudeDec + ", applattitudeDeg="
				+ applattitudeDeg + ", applongitudeDeg=" + applongitudeDeg + ", narcoticList=" + narcoticList
				...
				+ fromWhere + ", locationName=" + locationName + ", otherUnit=" + otherUnit + "]";
	}
