...
public class SatelliteAndOther {
	...
	public String toString() {
		return "SatelliteAndOther [threatId=" + threatId + ", threatTypeId=" + threatTypeId + ", threatTypeName="
				...
				+ sharedWithName + ", sharedWithOther=" + sharedWithOther + ", otherInfo=" + otherInfo + ", followUp="
				+ followUp + ", fromWhere=" + fromWhere + ", locationName=" + locationName + ", boatList=" + boatList
				+ ", boatStrList=" + boatStrList + ", vesselList=" + vesselList + ", vesselStrList=" + vesselStrList
				+ ", crewList=" + crewList + ", crewStrList=" + crewStrList + ", satIntercep=" + satIntercep
				+ ", satLattitude=" + satLattitude + ", satLongitude=" + satLongitude + ", satLattitudeDeg="
				+ satLattitudeDeg + ", satLongitudeDeg=" + satLongitudeDeg + ", satActTime=" + satActTime
				+ ", satDistance=" + satDistance + ", satDisType=" + satDisType + ", satDisTypeId=" + satDisTypeId
				+ ", satPlace=" + satPlace + ", satPlaceType=" + satPlaceType + ", satPlaceTypeId=" + satPlaceTypeId
				+ ", satPhone=" + satPhone + "]";
	}
