							...
							<div class="col-12   ml-auto mr-auto mb-4">
								<div class="multisteps-form__progress">
									...
									<button class="multisteps-form__progress-btn" type="button"
										title="Contraband Smuggling  Details" disabled="disabled">Contraband
										Smuggling Details</button>
									<button class="multisteps-form__progress-btn" type="button"
									...
									<div class="multisteps-form__panel shadow p-4 rounded bg-white"
										...
										<div class="multisteps-form__content">
											...
											<div class="row">
												...
												<div class="col-md-3">
													<div class="form-group">
														<label>Type of Contraband Seized</label>
														<!-- <input
															type="text" class="form-control" name="typeOfContra"
															id="typeOfContra" /> -->
														<select class="form-control select2" name="typeOfContra"
															id="typeOfContra">
															<option value="">Select</option>
															<c:forEach items="${contrabandTypeList}"
																var="contraListItem">
												...
												<div class="col-md-3">
													<div class="form-group">
														...
														<input type="number" class="form-control"
															onkeydown="return false" name="quantity" id="quantity"
															min="1" />
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group">
														...
														<select class="form-control select2 " name="weight"
															id="weight">
															<option value="">Select</option>
               			...
               			if(response.Status == 200){
               		    	...
               		    	// to remove all selected file  
    	           			 ...
    	           			 for (i = 0; i < obj.length; i++) { 
    	           			     ts+= "<li><a   href=\"viewdoc?fileName="+obj[i]+"&inputId=${inputId}&threatFolder=contrabandsmuggle\" target=\"_blank\"> <strong class=\"t\">"+obj[i]+"</strong>  </a>"
