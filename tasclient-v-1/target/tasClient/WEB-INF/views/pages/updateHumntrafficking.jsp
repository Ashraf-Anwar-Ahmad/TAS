							...
							<div class="col-12   ml-auto mr-auto mb-4">
								<div class="multisteps-form__progress">
									...
									<button class="multisteps-form__progress-btn" type="button"
										title="Contraband Smuggling  Details" disabled="disabled">Human
										Trafficking Details</button>
									<button class="multisteps-form__progress-btn" type="button"
							...
							<div class="col-12 m-auto">
								<form class="multisteps-form__form">
									...
									<div class="multisteps-form__panel shadow p-4 rounded bg-white"
										data-animation="scaleIn">
										<h3 class="multisteps-form__title">Details</h3>
										<div class="multisteps-form__content">

											<!--Human Trafficking details form strat-->
...
/* 	for(i in boatDataList){
	...
	console.log("imeiDataList "+imeiDataList);
...
//	$('#quantity').val(test.quantity);
	...
	$('#noOfpassesnger').val(test.noOfpassesnger);
	$('#investigationAgency').val(test.investigationAgency);
               			...
               			if(response.Status == 200){
               		    	...
               		    	// to remove all selected file  
    	           			 ...
    	           			 for (i = 0; i < obj.length; i++) { 
    	           			     ts+= "<li><a   href=\"viewdoc?fileName="+obj[i]+"&inputId=${inputId}&threatFolder=humantrafficking\" target=\"_blank\"> <strong class=\"t\">"+obj[i]+"</strong>  </a>"
...
function submitThreatDetails(){
 ...
 $.ajax({
		url : 'updateHumanTraffickingData',
