...
public class HumanTrafficing {
	...
	private List<String> PassengerBean;
	
	
	
	public List<String> getPassengerBean() {
		return PassengerBean;
	}
	public void setPassengerBean(List<String> passengerBean) {
		PassengerBean = passengerBean;
	}
	//added on 2 June 2022
...
//	}
	...
	public String getNoOfpassesnger() {
		return noOfpassesnger;
	}
	public void setNoOfpassesnger(String noOfpassesnger) {
		this.noOfpassesnger = noOfpassesnger;
	}
	public String getInvestigationAgency() {
		return investigationAgency;
	}
	public void setInvestigationAgency(String investigationAgency) {
		this.investigationAgency = investigationAgency;
	}
	...
	public String toString() {
		return "HumanTrafficing [threatId=" + threatId + ", threatTypeId=" + threatTypeId + ", threatTypeName="
				...
				+ ", imeiNo=" + imeiNo + ", contactList=" + contactList + ", nameSuspects=" + nameSuspects
				+ ", sharedWithId=" + sharedWithId + ", sharedWithOther=" + sharedWithOther + ", icgUnitsId="
				+ icgUnitsId + ", icgUnitsName=" + icgUnitsName + ", caseHandedTo=" + caseHandedTo + ", jointOperWith="
				+ jointOperWith + ", noOfpassesnger=" + noOfpassesnger + ", investigationAgency=" + investigationAgency
				+ ", applattitudeDec=" + applattitudeDec + ", applongitudeDec=" + applongitudeDec + ", applattitudeDeg="
				+ applattitudeDeg + ", applongitudeDeg=" + applongitudeDeg + ", PassengerBean=" + PassengerBean
				+ ", sharedWithName=" + sharedWithName + ", otherUnit=" + otherUnit + ", boatList=" + boatList
				+ ", boatStrList=" + boatStrList + ", vesselList=" + vesselList + ", vesselStrList=" + vesselStrList
				+ ", crewList=" + crewList + ", crewStrList=" + crewStrList + ", otherInfo=" + otherInfo + ", followUp="
				+ followUp + ", uploadDocs=" + uploadDocs + ", fromWhere=" + fromWhere + ", locationName="
				+ locationName + ", imeiList=" + imeiList + ", imeiStrList=" + imeiStrList + "]";
	}
